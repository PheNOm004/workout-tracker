# TimeGo Play store listing draft

## Listing copy

- **App name:** TimeGo
- **Short description:** Private, offline-first workout logging and progress review.
- **Full description:**
...
- 512px launcher icon: use the repository launcher artwork after visual review.
- 1024x500 feature graphic: [PUBLICATION INPUT: APPROVED FEATURE GRAPHIC]
- Phone screenshots: [PUBLICATION INPUT: APPROVED SCREENSHOT SET]
